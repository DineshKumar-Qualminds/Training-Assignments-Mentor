...
using Employee_API_DatabaseFirst.Model;

namespace Employee_API_DatabaseFirst.Controllers
{
    ...
    public class EmployeeDetailsController : ControllerBase
    {
        ...
        public EmployeeDetailsController(EmployeeDatabaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<EmployeeDetail>> PostEmployeeDetail(EmployeeDetail employeeDetail)
        {
            ...
            return CreatedAtAction("GetEmployeeDetail", new { id = employeeDetail.EmpId }, employeeDetail);
        }
